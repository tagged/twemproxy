...
rstatus_t memcache_fragment(struct msg *r, uint32_t nservers, struct msg_tqh *frag_msgq);
...
rstatus_t redis_fragment(struct msg *r, uint32_t nservers, struct msg_tqh *frag_msgq);
